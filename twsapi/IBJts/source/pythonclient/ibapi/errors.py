...
FAIL_SEND_REQSCANNERPARAMETERS = CodeMsgPair(
...
FAIL_SEND_REQCALCIMPLIEDVOLAT = CodeMsgPair(
    534, "Request Calculate Implied Volatility Sending Error - "
)
FAIL_SEND_REQCALCOPTIONPRICE = CodeMsgPair(
    535, "Request Calculate Option Price Sending Error - "
)
FAIL_SEND_CANCALCIMPLIEDVOLAT = CodeMsgPair(
    536, "Cancel Calculate Implied Volatility Sending Error - "
)
FAIL_SEND_CANCALCOPTIONPRICE = CodeMsgPair(
...
FAIL_SEND_REQMARKETDATATYPE = CodeMsgPair(
...
FAIL_SEND_SUBSCRIBETOGROUPEVENTS = CodeMsgPair(
...
FAIL_SEND_REQTICKBYTICKDATA = CodeMsgPair(
    576, "Request Tick-By-Tick Data Sending Error - "
)
FAIL_SEND_CANCELTICKBYTICKDATA = CodeMsgPair(
    577, "Cancel Tick-By-Tick Data Sending Error - "
)
FAIL_SEND_REQCOMPLETEDORDERS = CodeMsgPair(
...
FAIL_SEND_REQ_WSH_EVENT_DATA = CodeMsgPair(
    582, "Request WSH Event Data Sending Error - "
)
FAIL_SEND_CAN_WSH_EVENT_DATA = CodeMsgPair(
...
FAIL_SEND_REQCURRTIMEINMILLIS = CodeMsgPair(
