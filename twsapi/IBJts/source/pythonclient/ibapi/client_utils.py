...
from ibapi.protobuf.DeltaNeutralContract_pb2 import (
...
def createConditionsProto(order: Order) -> list[OrderConditionProto]:
    ...
    try:
        ...
        raise ClientException(
            ERROR_ENCODING_PROTOBUF.code(),
            ERROR_ENCODING_PROTOBUF.msg(),
...
def createMarketDepthRequestProto(
    ...
    numRows: int,
    isSmartDepth: bool,
    marketDepthOptionsList: TagValueList,
...
@staticmethod
def createCancelAccountUpdatesMultiRequestProto(
    reqId: int,
) -> CancelAccountUpdatesMultiProto:
...
def createRealTimeBarsRequestProto(
    ...
    whatToShow: str,
    useRTH: bool,
    realTimeBarsOptionsList: TagValueList,
